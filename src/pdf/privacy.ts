...
export const hasHighRiskFindings = (findings: DataRiskFinding[]) =>
  findings.some((finding) => finding.severity === "high");

export const buildPdfRiskInspectionText = (request: Pick<PdfSuggestRequest, "extractedText">) => request.extractedText;
